...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navView.setNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.nav_dashboard -> Toast.makeText(this, "Home Dashboard", Toast.LENGTH_SHORT).show()
                R.id.nav_arsip -> Toast.makeText(this, "Opening Archive...", Toast.LENGTH_SHORT).show()
                R.id.nav_trash -> Toast.makeText(this, "Opening Trash...", Toast.LENGTH_SHORT).show()
                R.id.nav_label -> Toast.makeText(this, "Opening Labels...", Toast.LENGTH_SHORT).show()
                R.id.nav_settings -> Toast.makeText(this, "Opening Settings...", Toast.LENGTH_SHORT).show()
                R.id.nav_help -> Toast.makeText(this, "Help & Feedback...", Toast.LENGTH_SHORT).show()
            }
